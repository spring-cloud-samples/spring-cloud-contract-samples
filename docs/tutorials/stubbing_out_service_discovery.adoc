...
`https://somenameforproducer/check` URL. You need to provide some properties to tell Stub
...
When you call the URL `https://somenameforproducer/check`, it will get redirected to a
