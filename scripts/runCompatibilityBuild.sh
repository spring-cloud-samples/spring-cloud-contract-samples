...
[[ -z "${CURRENT_CONTRACT_VERSION}" ]] && CURRENT_CONTRACT_VERSION="$( contractVersion "2.3" )"
[[ -z "${CURRENT_CLOUD_VERSION}" ]] && CURRENT_CLOUD_VERSION="$( cloudVersion "Ilford" )"
[[ -z "${PREVIOUS_BOOT_VERSION}" ]] && PREVIOUS_BOOT_VERSION="$( bootVersion "2.2" )"
...
function build_all_projects() {
    ...
    build consumer_with_junit5 "${consumerBootVersion}" "${consumerCloudVersion}" "${consumerVerifierVersion}"
