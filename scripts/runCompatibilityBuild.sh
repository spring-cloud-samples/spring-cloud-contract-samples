...
[[ -z "${CURRENT_BOOT_VERSION}" ]] && CURRENT_BOOT_VERSION="$(bootVersion "4.0")"
[[ -z "${CURRENT_CONTRACT_VERSION}" ]] && CURRENT_CONTRACT_VERSION="$(contractVersion "5.0")"
[[ -z "${CURRENT_CLOUD_VERSION}" ]] && CURRENT_CLOUD_VERSION="$(cloudVersion "2025.1")"
[[ -z "${PREVIOUS_BOOT_VERSION}" ]] && PREVIOUS_BOOT_VERSION="$(bootVersion "3.5")"
[[ -z "${PREVIOUS_CLOUD_VERSION}" ]] && PREVIOUS_CLOUD_VERSION="$(cloudVersion "2025.0")"
[[ -z "${PREVIOUS_CONTRACT_VERSION}" ]] && PREVIOUS_CONTRACT_VERSION="$(contractVersion "4.3")"
