...
//remove::start[]
@AutoConfigureStubRunner(stubsMode = StubRunnerProperties.StubsMode.LOCAL, ids = "com.example:beer-api-producer-routerfunction-webtestclient")
//remove::end[]
public class BeerControllerRouterFunctionTest extends AbstractTest {
	...
	//remove::start[]
	@StubRunnerPort("beer-api-producer-routerfunction-webtestclient") int producerPort;
