...
//remove::start[]
@AutoConfigureStubRunner(stubsMode = StubRunnerProperties.StubsMode.LOCAL, ids = "com.example:beer-api-producer-kotlin")
//remove::end[]
@DirtiesContext
public class BeerVerificationListenerKotlinTest extends AbstractTest {
